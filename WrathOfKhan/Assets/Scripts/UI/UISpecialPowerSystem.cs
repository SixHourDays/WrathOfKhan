...
public class UISpecialPowerSystem : UIPowerSystem
{
    ...
    protected override void UpdatePowerMouseOver()
    {
        ...
        bool powerNodeDestroyed = IsDestroyedPowerNode(1); //the destroy of special is both or neither
    ...
    protected override void AssignPower()
    {
        ...
        if ((IsMouseOverPowerNode(0) || IsMouseOverPowerNode(1)) && (availablePower >= 0) && !IsDestroyedPowerNode(1))
        {
            m_power = 2;
